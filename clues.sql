-- Clue #1: We recently got word that someone fitting Carmen Sandiego's description has been traveling through 
...
-- Clue #2: Now that we're here, we have insight that Carmen was seen attending language classes in this 
--country's officially recognized language. Check our databases and find out what language is spoken in this 
--country, so we can call in a translator to work with you.
...
--One is named the same as the country – that would be too obvious. We're following our gut on this one; 
...
-- Clue #7: She knows we're on to her – her taxi dropped her off at the international airport, and 
--she beat us to the boarding gates. We have one chance to catch her, 
--we just have to know where she's heading and beat her to the landing dock. 
--Lucky for us, she's getting cocky. She left us a note (below), 
--and I'm sure she thinks she's very clever, but if we can crack it, 
...
--send us the info, and we'll be sure to meet her 
--at the gates with bells on.

SELECT cities.name FROM cities WHERE cities.population = 91084;
